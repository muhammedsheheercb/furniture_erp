              ...
              <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-[#FAF8F6] border-b border-[#E5DDD5]">
                      ...
                      <th className="py-4 px-6 text-xs font-bold text-[#7A6055] uppercase">Category / Material</th>
                  ...
                  <tbody className="divide-y divide-[#F0EBE5]">
                    {products.length > 0 ? products.map((product) => (
                      <tr key={product._id} className="hover:bg-[#FAF8F6] transition-colors group">
                        <td className="py-4 px-6">
                          <div className="font-semibold text-[#1A1210]">{product.name}</div>
                          <div className="text-xs text-[#A89080]">SKU: {product.itemNumber}</div>
                        </td>
                        <td className="py-4 px-6">
                          <div className="flex flex-col gap-1">
                            <span className="text-sm font-medium text-[#7A6055]">{product.category}</span>
                            <span className="text-[10px] text-[#A89080] uppercase tracking-wider">{product.primaryMaterial || "N/A"}</span>
                          </div>
                        </td>
                        <td className="py-4 px-6">
                        ...
                        <td className="py-4 px-6 text-sm font-bold text-[#1A1210]"><CurrencySymbol /> {(product.salesAmount || 0).toLocaleString()}</td>
                    ...
                    <tr>
                      <td colSpan={6} className="py-10 text-center text-[#7A6055]">No products found</td>
                    </tr>
                  )}
                </tbody>
              </table>
