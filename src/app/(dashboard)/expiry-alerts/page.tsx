  ...
  return (
    <div className="page-container">
      ...
      >
        <div>
          ...
          <p style={{ fontSize: 13, color: "#7A6055", margin: "4px 0 0" }}>
            {t("furnitureItemsAndMaterialsThat")}
          </p>
        </div>
      </motion.div>
      ...
      >
        ...
        <input
          placeholder={t("searchItemNameOrNumber")}
          value={search}
        ...
        <table className="w-full">
          <thead>
            <tr>
              ...
              <th className="th text-end">{t("inStock")}</th>
              ...
              <tr>
                ...
                >
                  ...
                  >
                    ...
                    >
                      {t("allStockLevelsAreHealthy")}
                    </p>
                    <p style={{ fontSize: 13, color: "#A89080", margin: 0 }}>
                      {t("noItemsBelowTheThreshold")}
                      {THRESHOLD} {t("units")}
                    </p>
                  </div>
                </td>
              ...
              filtered.map((item, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td
                      className="td text-end"
                      style={{ fontWeight: 700, color: "#2C1810" }}
                    >
