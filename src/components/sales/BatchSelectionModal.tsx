            ...
            {availableBatches.map((batch, idx) => {
              ...
              return (
                <button
                  ...
                  className="group text-start p-4 rounded-2xl border-2 border-gray-100 bg-white hover:border-indigo-500 hover:shadow-lg hover:shadow-indigo-500/10 transition-all duration-200 relative overflow-hidden"
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-[10px] font-mono text-gray-400 bg-gray-50 px-1.5 py-0.5 rounded border border-gray-100 group-hover:bg-white/10 group-hover:border-white/20">
                          #{batch.purchaseNumber || "N/A"}
                        </span>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-x-6 gap-y-1.5 text-xs">
                        <div className="flex items-center gap-1.5 text-gray-500">
                          ...
                          <span>
                            {t("exp")}
                            <span
                              className={`font-semibold ${isExpired ? "text-red-500" : isNearExpiry ? "text-amber-500" : "text-gray-700"}`}
                            >
                              {batch.expiryDate
                    ...
                    <div className="flex flex-col items-end gap-1 px-4 border-s border-gray-100 h-full justify-center">
                  ...
                  {idx === 0 && (
                    <div className="absolute top-0 end-0">
                      <div className="bg-emerald-500 text-white text-[9px] font-bold px-2 py-0.5 rounded-es-lg shadow-sm">
                        {t("oldestFirst")}
                      </div>
                    </div>
                  )}
