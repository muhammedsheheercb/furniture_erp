...
const ItemSchema = new Schema<IItemDocument>(
  {
    itemNumber:      { type: String, required: [true, "SKU is required"], unique: true, trim: true },
    name:            { type: String, required: [true, "Product name is required"], trim: true },
    category:        { type: String, required: [true, "Category is required"], trim: true },
    primaryMaterial: { type: String, required: [true, "Primary material is required"], trim: true },
    ...
    quantity:        { type: Number, required: true, min: [0, "Stock cannot be negative"], default: 0 },
