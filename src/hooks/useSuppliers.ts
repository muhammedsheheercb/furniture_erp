...
export function useSuppliers() {
  ...
  const createSupplier = useCallback(async (form: ISupplierForm): Promise<boolean> => {
    try {
  ...
  const updateSupplier = useCallback(async (id: string, form: Partial<ISupplierForm>): Promise<boolean> => {
    try {
  ...
  return { suppliers, total, totalPages, loading, fetchSuppliers, createSupplier, updateSupplier, deleteSupplier };
}